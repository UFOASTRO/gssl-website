...
export default function Hero() {
  return (
    <section className="hero relative w-full min-h-[100svh] flex flex-col bg-transparent overflow-hidden">
      ...
      <div className="flex-1 flex flex-col lg:flex-row items-center justify-between relative z-20 w-full max-w-[1320px] mx-auto px-6 sm:px-8 lg:px-12 pt-24 lg:pt-20 pb-14 sm:pb-16 lg:pb-20 gap-10 lg:gap-24 xl:gap-32 mt-16 md:mt-0">
        ...
        <div className="relative z-10 w-full lg:flex-1 flex flex-col justify-center order-2 lg:order-1 pr-0 lg:pr-8">
          ...
          <h1 className="font-display text-navy-900 text-[clamp(2rem,7vw,4.5rem)] leading-[1.05] tracking-[-0.03em] max-w-[800px]">
            Building what Nigerian enterprise needs to grow.
          </h1>

          <p className="text-gray-600 text-[16px] sm:text-[18px] leading-relaxed max-w-lg mt-6">
        ...
        {/* Globe Container */}
        <div className="relative w-full lg:w-[45%] xl:w-[45%] max-w-[500px] lg:max-w-[600px] aspect-square flex-shrink-0 order-1 lg:order-2 z-10 pointer-events-auto mix-blend-darken opacity-90 mt-10 lg:mt-0">
          <Globe />
          
          {/* Card 1: Top Right */}
          <div className="absolute top-[5%] -left-1 md:-left-8 lg:-left-10 max-w-[170px] bg-white/50 backdrop-blur-md border border-white/60 p-4 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.06)] z-30 pointer-events-none transform translate-x-4 md:translate-x-0">
          ...
          {/* Card 2: Bottom Left */}
          <div className="absolute -bottom-[5%] -right-10 md:-right-0 lg:-right-10 max-w-[280px] bg-white/50 backdrop-blur-md border border-white/60 p-5 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.06)] z-30 pointer-events-none transform -translate-x-4 md:translate-x-0">
            <p className="text-navy-900/90 text-md font-medium leading-relaxed">
              We create impact with currently <span className="font-bold text-navy-900">4+ States impacted </span>bringing IT powered solutions <span className="font-bold text-navy-900">across nigeria</span>.
            </p>
          </div>
        </div>
