...
export default function Hero() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      tl.fromTo(".hero-card", 
        ...
        { scale: 1, opacity: 1, y: 0, stagger: 0.2, duration: 1, ease: "back.out(1.5)" }, 
        "-=1.2"
      );
    }, containerRef);
  ...
  return (
    <section ref={containerRef} className="hero relative w-full min-h-[100svh] flex flex-col bg-transparent overflow-hidden">
