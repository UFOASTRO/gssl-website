  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      tl.to(statsObj, {
        ...
        ease: "power2.out",
        onUpdate: () => {
          if (livesRef.current) livesRef.current.textContent = `${Math.floor(statsObj.lives)}k+`;
          if (statesRef.current) statesRef.current.textContent = `${Math.floor(statsObj.states)}+`;
        }
      }, "-=0.8");
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-stretch">
          ...
          <div className="relative w-full max-w-[500px] mx-auto lg:mx-0">
            ...
            >
              ...
              {/* Horizontal Bottom */}
              <line x1="25%" y1="75%" x2="75%" y2="75%" className="svg-line-2 animate-pulse" style={{ animationDelay: '0.1s' }} />
              {/* Vertical Left */}
              <line x1="25%" y1="25%" x2="25%" y2="75%" className="svg-line-3 animate-pulse" style={{ animationDelay: '.5s' }} />
              {/* Vertical Right */}
              <line x1="75%" y1="25%" x2="75%" y2="75%" className="svg-line-4 animate-pulse" style={{ animationDelay: '1s' }} />
            </svg>
          ...
          <div className="footprint-text-box bg-blue-900/20 border border-blue-500/20 backdrop-blur-md rounded-[2rem] p-8 sm:p-12 flex flex-col justify-center">
            ...
            <div className="footprint-stats grid grid-cols-2 gap-8 mt-auto pt-8 border-t border-white/10">
              <div>
                <div ref={livesRef} className="stat-lives text-4xl font-display font-bold text-blue-400 mb-2">300k+</div>
                <div className="text-gray-400 font-medium">Lives Impacted</div>
              </div>
              <div>
                <div ref={statesRef} className="stat-states text-4xl font-display font-bold text-blue-400 mb-2">5+</div>
