...
const partners = [
  ...
  { name: "Polaris Bank", src: "/Partners-logos/polaris-bank-logo-removebg-preview.png" },
  { name: "SMEDAN", src: "/Partners-logos/smedan-logo-removebg-preview.png" },
  { name: "Oyo State", src: "/Partners-logos/oyo-state-logo-removebg-preview.png" },
  { name: "Bauchi State", src: "/Partners-logos/bauchi-state-logo-removebg-preview.png" },
  { name: "Kano State", src: "/Partners-logos/kano-state-logo-removebg-preview.png" },
  ...
  { name: "Texaco", src: "/Partners-logos/Texaco_logo.svg-removebg-preview.png" },
];
