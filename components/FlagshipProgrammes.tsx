...
export default function FlagshipProgrammes() {
	...
	const programs = [
		{
			...
			description:
				"NATCO is our annual conference for Nigeria's informal sector. We partner with government and corporate sponsors to provide masterclasses in modern skills like solar installation and CNG conversion, giving thousands of artisans the certifications and tools they need to grow.",
		...
		},
		{
			...
			description:
				"Small businesses face big risks without insurance. In partnership with the Oyo State Government, the Ise D'otun Initiative provides training and the Oyo State Business Insurance, ensuring local merchants can grow safely and are protected from disasters.",
		...
		},
		{
			...
			description:
				"Local artisans need professional skills to work in Nigeria's energy sector. We run specialized training academies for the NNPC, giving graduates the skills, tools, and equipment they need to start their own businesses immediately.",
	...
	return (
		<section
			ref={sectionRef}
			id="initiatives"
			className="w-full bg-[#f8f9fa] py-24 sm:py-32 border-t border-b border-gray-100"
		>
			<div className="max-w-[1320px] mx-auto px-6 sm:px-8 lg:px-12">
				...
				<div className="max-w-3xl mb-16 sm:mb-20">
					...
					<p className="flagship-desc text-gray-600 text-lg sm:text-xl leading-relaxed">
						For over a decade, Global Sight Services Limited (GSSL) has operated
						at the intersection of public policy and private enterprise to
						deliver socioeconomic progress. Through strategic government
						partnerships and corporate alliances, we design and execute
						structured initiatives that verify trust, facilitate finance, and
						have directly transformed over 300,000+ lives.
					</p>
				</div>
