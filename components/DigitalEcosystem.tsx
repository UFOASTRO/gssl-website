...
function computeWeights(count: number, activeIndex: number | null, expand: number) {
  if (count <= 0) return [];
...
function HoverBentoGrid({
  ...
  expandX = 2,
  expandY = 1.35,
  duration = 350, // Much quicker animation
  easing = "cubic-bezier(0.25, 1, 0.5, 1)", // Snappier ease-out
}: any) {
...
export default function DigitalEcosystem() {
  const platforms = [
    ...
    },
    {
      ...
      description: "A platform for collecting and collating commerce data in Oyo State.",
