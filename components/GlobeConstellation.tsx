...
const MARKERS: GlobeMarker[] = STATES.map((state, i) => {
	...
	return {
		...
		location: [lat, lon],
		size: isReached ? 0.09 : 0.035, // Strong contrast in size
	};
});

// --- CONCEPT 4: NODE MAP (ZERO ARCS) ---
// Absolutely zero lines. It relies purely on the elegant placement of dots.
// This is the cleanest, most modern representation of a global footprint.
const ARCS: Arc[] = [];
...
export default function GlobeConstellation() {
