...
export default function NavBar() {
	...
	return (
		<>
			<div
				className={`navbar-anim fixed top-0 left-0 right-0 z-50 flex justify-center transition-[padding] duration-500 ease-in-out ${scrolled ? "pt-4 px-4 sm:px-6" : "pt-0 px-0"}`}
			>
				<nav
