	...
	return (
		<>
			...
			<section
				ref={sectionRef}
				id="contact"
				className="w-full bg-[#f8f9fa] py-24 sm:py-32 rounded-[3rem] mt-[-2rem] relative z-20 shadow-sm border-t border-gray-100"
			>
				<div className="max-w-[1320px] mx-auto px-6 sm:px-8 lg:px-12">
					<div className="max-w-3xl mx-auto text-center mb-16">
						...
						<p className="contact-desc text-gray-600 text-lg leading-relaxed">
							Whether you&apos;re looking to scale an enterprise, implement a
							state-wide initiative, or partner on digital verification—we have
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-20">
						...
						<div className="contact-card bg-white p-8 sm:p-10 rounded-[2rem] border border-gray-100 shadow-sm flex flex-col items-center text-center hover:shadow-md transition-shadow">
							...
							<h4 className="text-navy-900 text-2xl font-semibold mb-4">
								Headquarters
							</h4>
							<p className="text-gray-600 text-lg leading-relaxed">
								3B, Tunde Gabby Street, behind County Hospital, Ogba Aguda /
								Ojodu, Lagos, Nigeria
							</p>
						</div>
						...
						<div className="contact-card bg-white p-8 sm:p-10 rounded-[2rem] border border-gray-100 shadow-sm flex flex-col items-center text-center hover:shadow-md transition-shadow">
							...
							<p className="text-gray-600 text-lg leading-relaxed flex flex-col gap-2">
								...
								<span>
									<strong>Oyo:</strong> Ministry of Trade Secretariat, Agodi
								</span>
							</p>
						</div>
						...
						<div className="contact-card bg-white p-8 sm:p-10 rounded-[2rem] border border-gray-100 shadow-sm flex flex-col items-center text-center hover:shadow-md transition-shadow">
							...
							<a
								href="mailto:globalsightservices@gmail.com"
								className="text-blue-600 font-medium hover:text-blue-700 hover:underline flex items-center gap-2 text-lg"
							>
			...
			<footer
				ref={footerRef}
				className="w-full bg-navy-900 text-white pt-32 pb-8 overflow-hidden -mt-10 relative z-10"
			>
				<div className="max-w-[1320px] mx-auto px-6 sm:px-8 lg:px-12 flex flex-col items-center">
					<div className="w-full grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
						<div className="footer-col md:col-span-2">
							<h3 className="font-display text-2xl font-bold mb-6 tracking-wide">
								GSSL
							</h3>
							<p className="text-gray-400 max-w-sm">
								Empowering businesses by delivering tailored solutions that
