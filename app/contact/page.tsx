  ...
  return (
    <main className="min-h-screen bg-[#f8f9fa] flex flex-col pt-24 pb-12 px-6 sm:px-8 lg:px-12 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto w-full flex-1 flex flex-col justify-center relative z-10">
        <div className="mb-12">
          <Link href="/" className="inline-flex items-center text-gray-500 hover:text-navy-900 transition-colors font-medium">
        ...
        {step < 4 && (
          <div className="mb-8 w-full">
            <div className="flex justify-between items-center mb-4 text-xs font-semibold uppercase tracking-wider text-gray-400">
              ...
              <button
                onClick={() => { if (formData.firstName && formData.lastName) setStep(2); }}
              ...
              <div className="h-[2px] flex-1 bg-gray-200 mx-4" />
              <button
                onClick={() => { if (formData.firstName && formData.lastName && formData.email && formData.email.includes('@')) setStep(3); }}
          ...
          <AnimatePresence mode="wait">
            ...
            {step === 1 && (
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                  <div>
                    <label className="text-sm font-semibold text-gray-500 mb-2 block">First Name</label>
                    <input
                  ...
                  <div>
                    <label className="text-sm font-semibold text-gray-500 mb-2 block">Last Name</label>
                    <input
                      type="text"
            ...
            {step === 2 && (
              ...
              >
                ...
                <p className="text-gray-500 mb-8">We&apos;ll use this to get back to you.</p>
            ...
            {step === 3 && (
              ...
              >
                ...
                <p className="text-gray-500 mb-8">Tell us a bit about your project or inquiry.</p>
            ...
            {step === 4 && (
              ...
              >
                ...
                <p className="text-gray-600 text-lg mb-8 max-w-md">
                  Thank you for reaching out, {formData.firstName}. Our team will review your message and get back to you shortly at {formData.email}.
                </p>
                <Link
                  href="/"
        ...
        {step < 4 && (
          <div className="mt-8 text-center text-sm text-gray-400">
            Press <kbd className="font-sans px-2 py-1 bg-gray-200 text-gray-600 rounded-md mx-1">Enter</kbd> to continue
          </div>
        )}
      </div>
    </main>
